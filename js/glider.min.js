...
!(function(e) {
  ...
  window = "undefined" != typeof window ? window : this;
  var e = (window.Glider = function(e, t) {
      var o = this;
      ...
      o.track.classList.add("glider-track"),
        ...
        o.event(window, "add", { resize: o.resize });
    }),
    t = e.prototype;
  return (
    (t.init = function(e, t) {
      ...
      1 === Math.floor(d.opt.slidesToShow) && (h = 0),
        ...
        e &&
          ...
          (d.scrollLock = setTimeout(function() {
            clearTimeout(d.scrollLock),
              (d.ele.scrollLeft / d.itemWidth) % 1 &&
    ...
    (t.destroy = function() {
      ...
      (t.children[0].outerHTML = t.children[0].innerHTML),
        ...
        e.event(window, "remove", { resize: e.resize }),
        e.emit("destroy");
    }),
    (t.emit = function(e, t) {
      var o = new window.CustomEvent("glider-" + e, {
